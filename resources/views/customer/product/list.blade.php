            ...
            <div class="col-xxl-3 col-lg-4 product-box productbox">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="accordion accordion-flush app-accordion accordion-light-primary"
                                ...
                                <div id="collapse_three" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body p-2">
                                        <div class="p-2 d-flex align-items-center gap-2">
                                            ...
                                            <a href="#" class="f-s-15 f-w-500 text-secondary"><i
                                                    class="ph-duotone  ph-dress text-dark f-s-18 me-2"></i>Fashion </a>
                                        </div>
                                        <div class="p-2 d-flex align-items-center gap-2">
                                            <label class="check-box">
                                                <input type="checkbox">
                                            ...
                                            <a href="#" class="f-s-15 f-w-500 text-secondary"><i
                                                    class="ph-duotone  ph-desktop-tower text-dark f-s-18 me-2"></i>Home
                                                Appliances</a>
                                        </div>
                                        <div class="p-2 d-flex align-items-center gap-2">
                                            <label class="check-box">
                                            ...
                                            <a href="#" class="f-s-15 f-w-500 text-secondary"><i
                                                    class="ph-duotone  ph-first-aid-kit text-dark f-s-18 me-2"></i>Health
                                                & Beauty</a>
                                        </div>
                                        <div class="p-2 d-flex align-items-center gap-2">
                                            <label class="check-box">
                                            ...
                                            <a href="#" class="f-s-15 f-w-500 text-secondary"><i
                                                    class="ph-duotone  ph-game-controller text-dark f-s-18 me-2"></i>Toys
                                                & Game</a>
                                        </div>
                                        <div class="p-2 d-flex align-items-center gap-2">
                                            <label class="check-box">
                                            ...
                                            <a href="#" class="f-s-15 f-w-500 text-secondary"><i
                                                    class="ph-duotone  ph-basket text-dark f-s-18 me-2"></i>Groceries</a>
                                        </div>
                                        <div class="p-2 d-flex align-items-center gap-2">
                                            <label class="check-box">
                                                <input type="checkbox">
                                            ...
                                            <a href="#" class="f-s-15 f-w-500 text-secondary"><i
                                                    class="ph-duotone  ph-circles-three-plus text-dark f-s-18 me-2"></i>See
                                                all</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/10.jpg"
                                                        alt="">
                                                </a>
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="pricing-box">
                                                <h6>$390 <span>(<del>$400</del>)</span><span
                                                        class="text-success ms-2">12% off</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/14.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Watch</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/12.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500"> Shoes</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                                            <p class="text-secondary">Casual shoes for boys</p>
                                            <div class="pricing-box">
                                                <h6>$260 <span>(<del>$500</del>)</span><span
                                                        class="text-success ms-2">40% off</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/16.jpg "
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Jumpsuit</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/02.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Pents</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                                            <p class="text-secondary">comfortable pents for Girl</p>
                                            <div class="pricing-box">
                                                <h6>₹296 <span>(<del>₹999</del>)</span><span
                                                        class="text-success ms-2">70% off</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/06.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Hoodie</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                                            <p class="text-secondary">Men Solid Hooded Sweatshirt</p>
                                            <div class="pricing-box">
                                                <h6>$690 <span>(<del>$860</del>)</span><span
                                                        class="text-success ms-2">40% off</span></h6>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/03.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li>
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Jackets</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/08.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li>
                                                        <a href="wishlist.html"
                                                            class="bg-danger h-30 w-30 d-flex-center b-r-20">
                                                            <i class="f-s-18 ti ti-heart text-light"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="cart.html"
                                                            class="bg-primary h-30 w-30 d-flex-center b-r-20">
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Purce</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/18.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="pricing-box">
                                                <h6>$300 <span>(<del>$600</del>)</span><span
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/20.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li>
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">Backpacks</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/24.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="pricing-box">
                                                <h6>$300 <span>(<del>$600</del>)</span><span
                                                        class="text-success ms-2">50% off</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="product-content-box">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="#" class="image">
                                                    ...
                                                    <img class="images_box" src="../assets/images/ecommerce/22.jpg"
                                                        alt="">
                                                </a>
                                                <ul class="product-links">
                                                    <li><a href="wishlist.html"
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="product_details.html" class="m-0 f-s-20 f-w-500">T-shirt</a>
                                                <p class="text-warning m-0">4.2 <span class="text-warning"><i
                                                            class="ti ti-star-filled"></i></span></p>
                                            </div>
                                            <p class="text-secondary">Normal t-shirt for kids </p>
                                            <div class="pricing-box">
                                                <h6>$180 <span>(<del>$380</del>)</span><span
                                                        class="text-success ms-2">15% off</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
