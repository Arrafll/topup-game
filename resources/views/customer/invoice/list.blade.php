...
<main>
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 ">
                <h4 class="main-title">Cek Pesanan</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs app-tabs-primary order-tabs d-flex justify-content-start border-0 mb-0 pb-0"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-flex align-items-center gap-1" id="discover-tab"
                                    ...
                                    Menunggu Pembayaran</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-flex align-items-center gap-1" id="order-tab"
                                    data-bs-toggle="tab" data-bs-target="#order-tab-pane" type="button" role="tab"
                                    aria-controls="order-tab-pane" aria-selected="false" tabindex="-1"> 
                                    <i class="ph ph-arrow-fat-lines-right"></i>
                                    Sedang di Proses</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-flex align-items-center gap-1" id="order-tabs"
                                    ...
                                    aria-controls="order-tab-returns" aria-selected="false" tabindex="-1">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-flex align-items-center gap-1" id="ordertab"
                                    ...
                                    aria-controls="order-tab-cancelled" aria-selected="false" tabindex="-1"><i
                                        class="ti ti-square-rounded-x f-s-18 mg-b-3"></i> Batal</button>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body order-tab-content p-0">
                        <div class="tab-content" id="OutlineContent">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-primary">
                                                ...
                                                <td>$590</td>
                                                <td>
                                                    <a href="orders_details.html" role="button" target="_blank"
                                                        class="btn btn-outline-primary icon-btn w-30 h-30 b-r-22 me-2">
                                                        <i class="ti ti-eye"></i></a>
                                                    <button type="button"
                                                        class="btn btn-outline-success icon-btn w-30 h-30 b-r-22 me-2"><i
                                                            class="ti ti-edit"></i></button>
                                                    <button type="button"
                                                        class="btn btn-outline-danger icon-btn w-30 h-30 b-r-22 delete-btn"><i
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-success">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-danger">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-warning">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-info">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-light">
                                                        <img src="../assets/images/avtar/5.png" alt=""
                                                            class="img-fluid">
                                                    </div>
                                                    <span class="title-text mb-0">Bette Hagenes</span>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-dark">
                            ...
                            <!-- tab-2 -->
                            <div class="tab-pane fade" id="discover-tab-pane" role="tabpanel"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-2">
                                                    <div
                                                        class="h-25 w-25 d-flex-center b-r-50 overflow-hidden text-bg-secondary">
                                                        <img src="../assets/images/avtar/15.png" alt=""
                                                            class="img-fluid">
                                                    </div>
                                                    <span class="title-text mb-0">Emery McKenzie</span>
                                                </td>
                            ...
                            <!-- tab-4 -->
                            <div class="tab-pane fade" id="order-tab-returns" role="tabpanel"
                            ...
                            <!-- tab-5 -->
                            <div class="tab-pane fade" id="order-tab-cancelled" role="tabpanel"
                                aria-labelledby="order-tab" tabindex="0">
                                <div class=" order-list-table table-responsive app-scroll ">
                                    <table class="table table-bottom-border align-middle mb-0">
                                        <thead>
