...
@section('content')
    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="row m-1">
                <div class="col-12 ">
                    <h4 class="main-title">Voucher List</h4>
                    <ul class="app-line-breadcrumbs mb-3">
                        ...
                        <li class="active">
                            <a href="#" class="f-s-14 f-w-500">Voucher List</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Voucher List</h5>
                            <p>List data voucher yang ada pada game yang memiliki voucher.
                                Anda dapat menambah, mengubah, dan menghapus data voucher di sini.
                            </p>
