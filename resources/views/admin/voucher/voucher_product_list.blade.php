                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-7 col-12">
                                        <div class="ticket-create">
                                            ...
                                            <p class="mb-5 mt-3 text-secondary" style="text-align: justify;"> Halaman Data Voucher digunakan untuk
                                                mengelola berbagai informasi terkait voucher yang tersedia, seperti kode,
                                                jenis game, dan nilai sehingga proses transaksi dan pemberian voucher
                                                dapat dilakukan secara teratur dan efisien.</p>
