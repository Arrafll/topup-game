...
/*
|--------------------------------------------------------------------------
| Halaman Produk - Bisa Diakses oleh Guest dan Customer
|--------------------------------------------------------------------------
*/
Route::group(['middleware' => [\App\Http\Middleware\Role::class . ':guest,2']], function () {
...
/*
|--------------------------------------------------------------------------
| Auth - Login, Register, Google Login (hanya untuk guest)
|--------------------------------------------------------------------------
*/
Route::middleware(['guest'])->group(function () {
    ...
    Route::get('/guest_redirect', [AuthController::class, 'guest_redirect'])->name('guest_redirect');
});
...
Route::group(['middleware' => ['auth', \App\Http\Middleware\Role::class . ':2']], function () {
    ...
    // Order
    Route::get('/customer_order_now/{id}/{amount}/{game_id}', [CustomerController::class, 'order_now'])->name('customer_order_now');
