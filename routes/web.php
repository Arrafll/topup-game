...
Route::group(['middleware' => ['auth', \App\Http\Middleware\Role::class . ':1']], function () {
    ...
    Route::get('/admin_voucher_list', [AdminController::class, 'voucher_list'])->name('admin_voucher_list');
    ...
    Route::post('/admin_product_voucher/edit', [AdminController::class, 'updateVoucher'])->name('admin_product_voucher_update');
